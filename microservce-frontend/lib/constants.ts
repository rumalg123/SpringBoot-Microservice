...
export const ORDER_STATUS_COLORS: Record<string, { bg: string; border: string; color: string }> = {
  ...
  RETURN_REQUESTED:{ bg: "var(--warning-soft)", border: "var(--warning-border)", color: "var(--warning-text)" },
  RETURN_REJECTED: { bg: "var(--danger-soft)",  border: "var(--danger-glow)",    color: "var(--danger)" },
  REFUND_PENDING:  { bg: "var(--warning-soft)", border: "var(--warning-border)", color: "var(--warning-text)" },
