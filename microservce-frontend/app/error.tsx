...
export default function RootError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="min-h-[400px] flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <p className="mb-1.5 text-lg font-bold text-ink">Something went wrong</p>
      <p className="mb-5 max-w-[420px] text-sm text-muted">{error.message || "An unexpected error occurred. Please try again."}</p>
