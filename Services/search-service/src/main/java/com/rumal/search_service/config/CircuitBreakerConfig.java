...
import com.rumal.search_service.exception.DownstreamHttpException;
...
public class CircuitBreakerConfig {
    ...
    @Bean
    public Customizer<Resilience4JCircuitBreakerFactory> searchClientCircuitBreakerCustomizer(
    ...
    @Bean
    public RetryRegistry searchRetryRegistry(
