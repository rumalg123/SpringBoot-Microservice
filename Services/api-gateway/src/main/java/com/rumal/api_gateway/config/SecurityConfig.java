    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/admin/orders/**", "/admin/vendor-orders/**", "/admin/products/**", "/admin/promotions/**", "/admin/payments/**").access(this::hasAnyScopedAdminAccess)
                        .pathMatchers("/admin/me/**").access(this::hasAnyScopedAdminAccess)
                        .pathMatchers("/admin/**").access(this::hasSuperAdminAccess)
                        .pathMatchers("/customer-service/**", "/order-service/**", "/cart-service/**", "/wishlist-service/**", "/admin-service/**", "/product-service/**", "/poster-service/**", "/vendor-service/**", "/promotion-service/**", "/access-service/**", "/payment-service/**", "/discovery-server/**").denyAll()
