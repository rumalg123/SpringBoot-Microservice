    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/customer-service/**", "/order-service/**", "/cart-service/**", "/wishlist-service/**", "/admin-service/**", "/product-service/**", "/poster-service/**", "/vendor-service/**", "/promotion-service/**", "/access-service/**", "/payment-service/**", "/inventory-service/**", "/discovery-server/**").denyAll()
