...
public class SampleWishlistDataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        WishlistCollection aliceDefault = persistCollection(
                UUID.fromString("wc000001-0001-0001-0001-000000000001"),
                "kc-customer-alice", "My Wishlist", null,
                true, false, null);
        persistWishlistItem(UUID.fromString("wi000001-0001-0001-0001-000000000001"),
        ...
        persistWishlistItem(UUID.fromString("wi000002-0001-0001-0001-000000000002"),
        ...
        WishlistCollection aliceShared = persistCollection(
                UUID.fromString("wc000002-0001-0001-0001-000000000002"),
                "kc-customer-alice", "Gift Ideas", "Things I'd love to receive!",
                false, true, "alice-gift-ideas-2025");
        persistWishlistItem(UUID.fromString("wi000003-0001-0001-0001-000000000003"),
        ...
        WishlistCollection bobDefault = persistCollection(
                UUID.fromString("wc000003-0002-0002-0002-000000000003"),
                "kc-customer-bob", "My Wishlist", null,
                true, false, null);
        persistWishlistItem(UUID.fromString("wi000004-0002-0002-0002-000000000004"),
                ...
                bd("59.00"), null);
        persistWishlistItem(UUID.fromString("wi000005-0002-0002-0002-000000000005"),
        ...
        WishlistCollection carolDefault = persistCollection(
                UUID.fromString("wc000004-0003-0003-0003-000000000004"),
                "kc-customer-carol", "My Wishlist", null,
                true, false, null);
        persistWishlistItem(UUID.fromString("wi000006-0003-0003-0003-000000000006"),
        ...
        WishlistCollection carolKitchen = persistCollection(
                UUID.fromString("wc000005-0003-0003-0003-000000000005"),
                "kc-customer-carol", "Kitchen Upgrades", "Home kitchen essentials",
                false, false, null);
        persistWishlistItem(UUID.fromString("wi000007-0003-0003-0003-000000000007"),
    ...
    private void persistWishlistItem(UUID id, String keycloakId, WishlistCollection collection,
        ...
        em.persist(WishlistItem.builder()
                .id(id)
                .keycloakId(keycloakId)
