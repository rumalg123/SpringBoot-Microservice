...
public class AdminVendorController {
    ...
    public Map<String, Object> create(
        ...
        internalRequestVerifier.verify(internalAuth);
        return adminVendorService.create(request, internalAuth);
    }
    ...
    public Map<String, Object> update(
        ...
        internalRequestVerifier.verify(internalAuth);
        return adminVendorService.update(id, request, internalAuth);
    }
    ...
    public void delete(
        ...
        internalRequestVerifier.verify(internalAuth);
        adminVendorService.delete(id, internalAuth);
    }
    ...
    public Map<String, Object> restore(
        ...
        internalRequestVerifier.verify(internalAuth);
        return adminVendorService.restore(id, internalAuth);
    }
