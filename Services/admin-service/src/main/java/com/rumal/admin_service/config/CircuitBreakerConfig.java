...
public class CircuitBreakerConfig {
    ...
    @Bean
    public Customizer<Resilience4JCircuitBreakerFactory> adminClientCircuitBreakerCustomizer(
            ...
            @Value("${resilience.circuit-breaker.slow-call-duration-ms:3000}") long slowCallDurationMs,
            ...
            @Value("${resilience.time-limiter.timeout-ms:4000}") long timeoutMs
    ) {
        return factory -> {
