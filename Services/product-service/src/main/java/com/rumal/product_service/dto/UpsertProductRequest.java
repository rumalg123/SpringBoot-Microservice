...
public record UpsertProductRequest(
        ...
        @Size(max = 100, message = "brandName must be at most 100 characters")
        String brandName,

        @NotEmpty(message = "images must contain at least one item")
        @Size(max = 10, message = "images cannot contain more than 10 items")
        ...
        @DecimalMin(value = "0.00", inclusive = false, message = "discountedPrice must be greater than 0 when set")
        ...
        @Min(value = 0, message = "weightGrams cannot be negative")
        Integer weightGrams,

        @DecimalMin(value = "0.00", message = "lengthCm cannot be negative")
        BigDecimal lengthCm,

        @DecimalMin(value = "0.00", message = "widthCm cannot be negative")
        BigDecimal widthCm,

        @DecimalMin(value = "0.00", message = "heightCm cannot be negative")
        BigDecimal heightCm,

        @Size(max = 70, message = "metaTitle must be at most 70 characters")
        String metaTitle,

        @Size(max = 160, message = "metaDescription must be at most 160 characters")
        String metaDescription,

        @Valid
        List<UpsertProductSpecificationRequest> specifications,
