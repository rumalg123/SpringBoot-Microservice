...
@Service
public class ProductAuditRequestContextResolver {

    public ProductAuditRequestContext resolve(String actorSubOverride, String actorRolesOverride, String changeSourceOverride) {
        ...
        String actorType = StringUtils.hasText(actorSub) && !"system".equalsIgnoreCase(actorSub) ? "USER" : "SYSTEM";
        ...
        return new ProductAuditRequestContext(actorSub, actorTenantId, actorRoles, actorType, changeSource, clientIp, userAgent, requestId);
    }
