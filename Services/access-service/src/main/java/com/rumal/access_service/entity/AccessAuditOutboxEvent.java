...
@Entity
@Table(
        name = "access_audit_outbox",
        indexes = {
                @Index(name = "idx_access_audit_outbox_pending", columnList = "processed_at, available_at"),
                @Index(name = "idx_access_audit_outbox_target", columnList = "target_type, target_id")
        }
)
@Getter
@Setter
...
@AllArgsConstructor
@Builder
public class AccessAuditOutboxEvent {
