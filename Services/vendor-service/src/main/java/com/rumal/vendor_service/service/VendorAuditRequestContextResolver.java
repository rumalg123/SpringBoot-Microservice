...
@Service
public class VendorAuditRequestContextResolver {

    public VendorAuditRequestContext resolve(String actorSubOverride, String actorRolesOverride, String changeSourceOverride) {
        ...
        return new VendorAuditRequestContext(actorSub, actorTenantId, actorRoles, actorType, changeSource, clientIp, userAgent, requestId);
    }
